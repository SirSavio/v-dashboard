  ...
  <div class="flex justify-center items-center h-screen bg-gray-200 px-6">
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
      <div class="flex justify-center items-center">
        ...
        <span class="text-gray-700 font-semibold text-2xl">iStones</span>
      </div>
      ...
      <form class="mt-4" @submit.prevent="login">
        ...
        <div class="flex justify-between items-center mt-4">
          ...
          <div>
            <a
              class="block text-sm fontme text-red-700 hover:underline"
              href="#"
              >Esqueceu a senha?</a
            >
          </div>
        ...
        <div class="mt-6">
          <button
            type="submit"
            class="py-2 px-4 text-center bg-red-600 rounded-md w-full text-white text-sm hover:bg-red-700"
          >
            Sign in
          </button>
        </div>
